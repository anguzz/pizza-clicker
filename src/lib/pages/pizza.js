export function Onion() {    
    ...
    can.onclick= function(evt) {
        ...
        export   function CheeseSprinkles() {
    var can = document.getElementById("painter"),
        // @ts-ignore
        ctx = can.getContext('2d'),
        onion = new Image();
